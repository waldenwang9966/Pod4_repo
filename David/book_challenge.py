...
'''
print('\nPart 2\n')
my_library.add('Just Mercy,',  'by Bryan Stevenson')
my_library.add('The New Jim Crow,', 'byby  Michelle Alexander')
my_library.add('The Truths We Hold,', 'by Kamala Harrisn')
my_library.add('My Grandmothers Hands,', 'by Resmaa Menakem')
...
nyt_bestseller.add('Verity,', 'by Colleen Hoover')
nyt_bestseller.add('The Body Keeps the Score,', 'by Bessel van der Kolk')

for book in nyt_bestseller.books:
    print(book.title, book.author)
'''
BONUS Part #6:
In book_list_class.py:
