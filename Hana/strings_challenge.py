...
# There are 3 ways to print multiple items
...
print(ingredient_1 + ", " + ingredient_2 + ", " + ingredient_3 + ", and " + ingredient_4)
...
# When we use a string method in a print statement, does it change the string in our variable? NO
...
# 2.5 Update our `ingredients` variable using the replace method, the same way we printed it out in step 2.
...
print(f"Roughly how many times a week do you make time to {activity}?")

# 3.3 When the user inputs a number, what data type is it saved as? #String
...
print(f'We recommend you {activity} at least {str(frequency) * 2} times a week!')

# Not sure why it links me to my C: when I run the code for line 81
