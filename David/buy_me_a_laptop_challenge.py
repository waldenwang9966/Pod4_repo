...
print(f"The url for Macnook is: {laptops[0]['url']}\n")
...
print(f"The availabe colors for the Dell XPS 13 are: {laptops[1]['types'][0]['colors']}\n")

# TODO: Write code to print the description of Dell XPS laptop.
print(f"Here is the description for Dell XPS 13: \n{laptops[1]['description']}")
print()
