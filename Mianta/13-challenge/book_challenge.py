...
'''In this script: Then, create an object of class Booklist called 'my_library'.
...
my_library.add("Just Mercy")
my_library.add("The New Jim Crow")
my_library.add("The Truths We Hold")
my_library.add("My Grandmother's Hands")
#not sure if the authors were wanted in the print so I did not include them
print(my_library.books)
