...
print('d is now set to False because both sides in the comparison are False instead of only one. 5 is not greater than 7 and even though 8 is less than 20, the "not" changes it to False.')
