...
def vaildate_user_input():
 while True:
    try:
        number = int(input("Please enter a number"))
    except ValueError: 
        print("You did not enter a vaild number, please try again")
