...
'''
print('\nPart 3\n')
# I'm assuming the 'None' after the result is because we had to format the 'add()' method?!
# Also, when I had my .append formatted with an f-string, the len(self.books) was correct with a count of 4
# but now it says 8 because I had to change the formatting.
