...
class SubwayStation(Station):
    def __init__(self, lines, station_name, location):
        super().__init__(station_name, location)
        self.lines = lines

    def show_info(self):
        print(f'{self.lines} are the lines that stop at {self.station_name} station. {self.station_name} station is located at {self.location}.')
