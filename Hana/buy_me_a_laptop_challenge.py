...
print(
    "Question 1: You are given a list containing the laptop names. Print the names of each the laptops separately."
)
...
print(
    f'All possible prices of the 16-inch MacBook Pro: {laptops[0]["types"][1]["price"]}'
)
...
print(
    "Suppose that the 13-inch MacBook Pro in space gray color is sold out. Also, the same laptop with 256 GB storage is out of stock as well. Update the list of dictionaries such that these options are removed. Print the updated dictionary."
)
...
print(
    "Time to look at the range of prices. Using a nested loops, print out all possible computer prices"
)
