...
In this challenge, you will use OOP and inheritance to design subway and bus stations!You'll use the parent class Station to make child classes for SubwayStation and BusStation. 
...
-have an additional attribute called 'lines' that is user-defined as a list during initialization. This will indicate which subway lines stop at the station (for example ['A', 'C'])
...
test = SubwayStation("x","y","h")
print(test.show_info)
print('Question 2: Make an example subway station')
'''
Using your SubwayStation class, instantiate a subway station with the info below. Then run the show_info() method to make sure you get the station_name, location, and lines printed out
...
''''
BusStation should:-have an additional attribute called 'routes' that is user-defined as a list during initialization. 
