...
print(f'Four Barrel Coffee restaraunt is located at {restaurant["address1"]} {restaurant["city"]} {restaurant["state"]} {restaurant["zip_code"]}')
...
restaurant_1 = {
    "name": "Papa Johns",
    "address": "250 East 151st Bronx, Ny 10453",
    "favourite_dish": "Pizza Pie"
}

restaurant_2 = {
    "name": "McDonalds",
    "address": "260 West 125th NY, NY 10015",
    "favourite_dish": "Big Mack"
}

restaurant_3 = {
    "name": "Taco Bell",
    "address": "270 West 110th St NY, NY 10013",
    "favourite_dish": "Tacos"
}
...
restaurant_2['address'] = "473 Prospect Aveune"
