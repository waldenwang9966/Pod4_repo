...
syntaxError_1 = 'The completion message variable was written with a space, which is not allowed in variable naming. The error was fixed by adding _ between the two words.'
syntaxError_2 = 'The string assigned to the completion_message variable did not contain a closing quotation mark.'
