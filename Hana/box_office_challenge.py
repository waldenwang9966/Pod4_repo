...
# TODO: Take the string "movies_str" and convert it into a list and assign it to a variable called 
#"remaining_50_list"

remaining_50_list = ['House on Haunted Hill' , 'Cruel Intentions', '10 Things I Hate About You','My Favorite Martian', '8MM', 'Fight Club','The Matrix', 'Any Given Sunday','The Thin Red Line','A Bugs Life' ,'For Love of the Game','Instinct', 'Mickey Blue Eyes', 'The Best Man', 'Bicentennial Man', 'The 13th Warrior', 'October Sky' , 'Lake Placid', 'Random Hearts', 'Mighty Joe Young', 'Superstar', 'Mystery Men', 'The Talented Mr. Ripley', 'Dogma', 'The Out-of-Towners', 'The Other Sister', 'Baby Geniuses', 'The Story of Us', 'Blast from the Past', 'The Insider', 'Saving Private Ryan', 'Mysteries of Egypt', 'The Wood', 'Arlington Road', 'T-Rex: Back to the Cretaceous', 'The Iron Giant', 'Edtv', 'At First Sight', 'The Faculty', 'Summer of Sam', 'The Bachelor', 'Stir of Echoes', 'Anna and the King', 'Man on the Moon', 'Galaxy Quest', 'Enemy of the State', 'Waking Ned Devine', 'Dougs 1st Movie','An Ideal Husband' , 'Everest'] 
...
# TODO: Great! Let's join the two lists into one list called "top_100". Uncomment the line of code below and run your code to see how it's done!
 #Print your new variable to see the combined list of movies
