...
client_name = input ('Please enter youe name-')
...
# TODO: asked client what their savings account amount and saved it to another variable.
...
# TODO: Write code to asked the client the stock they are interested in and saved it to another variable, as shown below.
...
# TODO: all 3 user inputs stores in variables. Based on that, wrote conditional (if-elif-else) statements to find out the number of stocks of the company that can be purchased with the savings amount.
