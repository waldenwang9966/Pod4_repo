...
class SubwayStation1(Station):
        def __init__(self, station_name, location, lines):
            ...
            self.lines = lines
        def show_info(self):
            print(f'{self.station_name} station is located at {self.location} on the {self.lines}')
...
busStation1 = BusStation( station_name="NYC Megabus Stop", location="34th street and 12th avenue", routes=["Boston", "DC", "Philly"])
