...
print(restaurant['name'], restaurant['address1'], restaurant['city'], restaurant['state'], restaurant ['zip_code'], restaurant['country'])
...
restaurant_1['address'] = '100 Bank Street'
print(restaurant_1)
