...
for day in days: #this is the loop that breaks down the days to ask user what their fav activity is.
    ...
    activities.append(user_activity)  #this is where the user input is saved and added to the activites variable.
...
for i in range(len(days)):
    print(f'On {days[i]}, favorite activity is to {activities[i]}.') #this is where I used the range function, and used (len) to list the days on seperate lines asking user what fav activity is 
...
# Try to break down the steps required for this second loop challenge.
    ...
    # 3- saved user input and added to the activites variable. 

    # 4- this is where I used the range function, and used (len) to list the days on seperate lines asking user what fav activity is 
...
print(temperature) #prints temp in a string
