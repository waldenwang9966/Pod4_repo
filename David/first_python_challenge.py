...
google_months = google_age * 12
print(f'{google_months} months old')
...
# 1) took out hash 2) added underscore in variable 3) added a closing quotation at the end of string
